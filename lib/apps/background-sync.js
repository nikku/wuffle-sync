...
module.exports = async (app, config, store) => {
  ...
  const log = app.log.child({ name: 'background-sync' });
  ...
  async function doSync(repositories) {
    ...
    for (const repositoryName of repositories) {
      ...
      log.info('syncing', { repositoryName });
      ...
      try {
        ...
        log.info('synched', { repositoryName });
        ...
        log.warn('failed to synchronize', { repositoryName }, error);
      }
  ...
  async function backgroundSync() {
    ...
    try {
      ...
      log.warn('failed to synchronize project', error);
    }
  }
